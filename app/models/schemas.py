...
class TestStep(BaseModel):
   action:Literal["navigate","fill","select","click","assert_visible","assert_not_visible","assert_text"]; target:Optional[dict]=None; value:Optional[str]=None
